...
static constexpr auto STATUS_SERVER_NAME = "OT - Premium Server";
static constexpr auto STATUS_SERVER_VERSION = "Based on TFS 1.3";
static constexpr auto STATUS_SERVER_CREDITS = "OT Team and Contributors, OTXServer (Mattyx Gomez) and The Forgotten Server Developers";
